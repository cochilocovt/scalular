...
export function TrustSection() {
  return (
    <section className="py-24 px-6 md:px-12 max-w-[1600px] mx-auto bg-background">
      <div className="flex flex-col md:flex-row gap-16 items-center">
        <div className="flex-1 max-w-xl">
          <h2 className="text-3xl md:text-5xl font-bold text-text-primary mb-6">Trust on a scale, <br/> built on verification.</h2>
          ...
          <div className="space-y-6">
            {trustItems.map((item, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-full neu-btn border border-divider flex items-center justify-center shrink-0">
                  {item.icon}
                </div>
                <div>
        ...
        <div className="flex-1 w-full">
          ...
          >
            <Card className="p-8 md:p-12 relative overflow-hidden">
              ...
              <div className="flex items-center justify-between border-b border-divider pb-6 mb-6 relative z-10">
                <div className="text-text-primary font-medium">Compliance Dashboard</div>
              ...
              <div className="space-y-4 relative z-10">
                {[1, 2, 3].map((_, i) => (
                  <div key={i} className="bg-surface rounded-xl p-4 border border-divider flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full neu-btn" />
                      <div>
                        <div className="w-32 h-4 bg-text-secondary/20 rounded mb-2" />
                        <div className="w-24 h-3 bg-text-secondary/10 rounded" />
                      </div>
                    </div>
