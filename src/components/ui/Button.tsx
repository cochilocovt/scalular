...
export function Button({
  ...
  const variants = {
    primary: 'bg-primary text-white hover:bg-primary/90 shadow-[0_0_15px_rgba(34,211,166,0.4)] hover:shadow-[0_0_25px_rgba(34,211,166,0.6)] font-semibold border-none',
