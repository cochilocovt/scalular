      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-8">
          ...
          <div className="flex flex-wrap gap-10 text-sm">
            <div className="flex flex-col gap-2">
              <span className="text-[10px] font-semibold tracking-widest uppercase text-text-secondary/60 mb-1">Company</span>
            ...
            <div className="flex flex-col gap-2">
              <span className="text-[10px] font-semibold tracking-widest uppercase text-text-secondary/60 mb-1">Product</span>
            ...
            <div className="flex flex-col gap-2">
              <span className="text-[10px] font-semibold tracking-widest uppercase text-text-secondary/60 mb-1">Legal</span>
        ...
        <div className="pt-6 border-t border-divider flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs text-text-secondary/40">Built in Tiruppur — India&apos;s knitwear capital · contactus@scalular.com</p>
        </div>
      </div>
    </footer>
  );
