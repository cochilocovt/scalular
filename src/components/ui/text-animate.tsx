...
interface TextAnimateProps extends MotionProps {
  ...
  once?: boolean
  /**
   * The stagger delay between elements
   */
  stagger?: number
}
...
export function TextAnimate({
  ...
  const MotionComponent = (typeof Component === "string" && Component in motion ? motion[Component as keyof typeof motion] : motion.p) as any
